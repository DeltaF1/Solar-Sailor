...
TLfres = {}	-- namespace
local lg, trans, scale, color, rect, lw = love.graphics, love.graphics.translate, love.graphics.scale, love.graphics.setColor, love.graphics.rectangle, love.window
